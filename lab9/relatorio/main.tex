...
\begin{figure}[htbp]
\centering
\centerline{\includegraphics[scale=0.3]{imagens/acc.png}}
...
\begin{figure}[htbp]
\centering
\centerline{\includegraphics[scale=0.5]{imagens/loss.png}}
...
\begin{figure}[htbp]
\centering
\centerline{\includegraphics[scale=0.5]{imagens/val_acc.png}}
...
\begin{figure}[htbp]
\centering
\centerline{\includegraphics[scale=0.5]{imagens/val_loss.png}}
